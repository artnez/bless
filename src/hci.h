...
#define HCI_DEVICE_ADV_UNDIRECTED_CONNECTABLE 0x00
#define HCI_DEVICE_ADV_DIRECTED_CONNECTABLE 0x01
#define HCI_DEVICE_ADV_UNDIRECTED_DISCOVERABLE 0x02
#define HCI_DEVICE_ADV_UNDIRECTED_NONCONNECTABLE 0x03
